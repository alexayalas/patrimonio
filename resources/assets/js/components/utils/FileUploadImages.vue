<template>
    <div class="container well col-md-12">
        <div class="col-md-4 mt-20">
            <label for="images_uploads" class="custom-file-upload"><i class="fa fa-plus"></i> Seleccionar Imagenes</label>
            <input
                type="file"
                id = "images_uploads"
                :name="name"
        ...
        <div class="col-md-4 mt-20" v-if="data_images.files_images != 0">
            <!--<button class="btn btn-primary btn-sm" @click.prevent="AddFiles"><i class="fa fa-plus"></i> Archivos</button>-->
            <button class="btn btn-success btn-sm" @click.prevent="UploadFiles"><i class="fa fa-cloud-upload"></i> Subir <span class="badge">{{ data_images.files_images.length }}</span> Archivos</button>
        </div> 
        ...
        <div class="preview col-md-12">
            ...
            <table class="table table-striped jambo_table bulk_action" v-if="data_images.files_images != 0">
                <thead>
                    <tr class="headings">
