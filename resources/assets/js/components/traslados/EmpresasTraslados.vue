<template>
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Traslados por Empresas</li>
        </ol>
        </section>    
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6" v-for="empresa in empresas" :key="empresa.id">
                    ...
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h3>{{ getTrasladosByEmpresaId(empresa.id).length }}</h3>
                            <p>Traslados</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-home"></i>
                        </div>
                        <router-link class="small-box-footer" :to="{ name: 'Traslados', params : { empresa: empresa.id }}" exact>
...
export default {
    ...
    computed: {
        ...mapState(['empresas']),
        ...mapGetters(['getTrasladosByEmpresaId']),        
    },    
}
</script>
