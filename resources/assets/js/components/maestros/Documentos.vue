                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"> 
                            ...
                            <div class="row">
                                <button type="button" class="btn btn-info pull-right mr-10" @click.prevent="LoadForm"><i class="material-icons bootstro-prev-btn mr-5">store_mall_directory</i> Nuevo Documento</button>
                            </div>                                                        
                        </div>
                        <div class="panel-body">
                            ...
                            styleClass="table condensed table-bordered table-striped">
                                <template slot="table-row" slot-scope="props">
                                    <td class="enlace" @click.prevent="processEdit(props.row)">{{ props.row.nombre_documento }}</td>
        ...
        <modal name="documento" :width="'50%'" :height="'auto'" :scrollable="true" :clickToClose="false">
            ...
            <div>
                <div class="row title-form">
                    ...
                    <div class="pull-right close-form" @click="$modal.hide('documento')"><i class="glyphicon glyphicon-remove"></i></div>                
                </div>
