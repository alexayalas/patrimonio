                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"> 
                            ...
                            <div class="row">
                                <button type="button" class="btn btn-info pull-right mr-10" @click.prevent="LoadForm"><i class="material-icons bootstro-prev-btn mr-5">store_mall_directory</i> Nueva Sede</button>
                            </div>                                                        
                        </div>
        ...
        <modal name="sede" :width="'50%'" :height="'auto'" :scrollable="true" :clickToClose="false">
            ...
            <div>
                <div class="row title-form">
                    <h3 class="pull-left h3-title">Registro de Sede</h3>
                    <div class="pull-right close-form" @click="$modal.hide('sede')"><i class="glyphicon glyphicon-remove"></i></div>                
                </div>
